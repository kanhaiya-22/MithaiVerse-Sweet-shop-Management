    ...
    <div className="min-h-screen bg-muted/30 font-sans">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="font-heading text-3xl font-bold">Inventory Management</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold">{MOCK_SWEETS.length}</div>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
              ...
              <TableBody>
                {MOCK_SWEETS.map((sweet) => (
                  <TableRow key={sweet.id}>
                    ...
                    <TableCell>
                      <Badge variant="outline" className="bg-secondary/20 hover:bg-secondary/30 border-secondary text-secondary-foreground">
                        {sweet.category}
                      </Badge>
                    </TableCell>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        {sweet.stock === 0 ? (
                          ...
                          <span className="text-green-600 font-medium">{sweet.stock} in stock</span>
                        )}
                      </div>
                    </TableCell>
